...
import { useCreatePlan } from "@/renderer/hooks/use-plans";
...
export type OnboardingStepKey = "household" | "retirement-timing" | "assets" | "income-phases" | "spending-target";
...
const STEPS: OnboardingStepKey[] = ["household", "retirement-timing", "assets", "income-phases", "spending-target"];
